...
import { Activity, AlertTriangle, DollarSign, Percent, Users, Shield, Clock, Ban } from 'lucide-react';
...
const mockTransactions: Transaction[] = [
  {
    ...
    userEmail: 'tpresillareddy@gmail.com', transactionType: 'purchase'
  },
  {
...
const mockAlerts: AlertMessage[] = [
  {
    ...
    timestamp: new Date().toISOString(), category: 'pattern', affectedUser: 'tpresillareddy@gmail.com',
  ...
  },
  {
    ...
    timestamp: new Date(Date.now() - 1800000).toISOString(), category: 'location', affectedUser: 'tpresillareddy@gmail.com',
  ...
  },
  {
    ...
    timestamp: new Date(Date.now() - 3600000).toISOString(), category: 'pattern', affectedUser: 'tpresillareddy@gmail.com',
